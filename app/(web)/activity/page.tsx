...
const SPORT_CATEGORIES = [
  {
    label: "Semua",
    value: "",
    img: "https://images.unsplash.com/photo-1546519638405-a9e8a4a25f4b?w=100",
  },
  {
    label: "Mini Soccer",
    value: "MINI_SOCCER",
    img: "https://images.unsplash.com/photo-1431324155629-1a6deb1dec8d?w=100",
  },
  {
    label: "Sepak Bola",
    value: "FUTSAL",
    img: "https://images.unsplash.com/photo-1553778263-73a83bab9b0c?w=100",
  },
  {
    label: "Bulu Tangkis",
    value: "BADMINTON",
    img: "https://images.unsplash.com/photo-1626224583764-f87db24ac4ea?w=100",
  },
  {
    label: "Basket",
    value: "BASKETBALL",
  ...
  },
  {
    label: "Tenis",
    value: "TENNIS",
    img: "https://images.unsplash.com/photo-1554068865-24cecd4e34b8?w=100",
  },
  {
    label: "Bola Voli",
    value: "VOLLEYBALL",
    img: "https://images.unsplash.com/photo-1612872087720-bb876e2e67d1?w=100",
  },
  {
    label: "Padel",
    value: "PADEL",
...
function ActivityContent() {
  ...
  const fetchEvents = async (p = 1) => {
    ...
    try {
      ...
      setMeta(
        res.data.meta || { total: res.data.length, page: 1, totalPages: 1 },
      );
    } catch {
    ...
    <div className="max-w-7xl mx-auto px-6 py-10">
      ...
      <div className="flex gap-4 overflow-x-auto pb-2 mb-8">
        {SPORT_CATEGORIES.map((cat) => (
          <button
            ...
            <span
              className={`text-xs font-medium ${category === cat.value ? "text-purple-600" : "text-gray-600"}`}>
              {cat.label}
            </span>
          </button>
        ))}
      ...
      <div className="mb-4">
        <select
          ...
          className="w-full md:w-64 px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-purple-500">
